class MedicalRecordsController < ApplicationController
  ...
  private
    ...
    def medical_record_params
      params.require(:medical_record).permit(:name, :dob, :sex, :phone_number, :address, :allergies, :insurance, :emergency_contact, :blood_type, :pre_exsisting_medical_conditions, :primary_doctor, :medication, :previous_injuries, :past_hospital_visits, :reason_for_ER_visit)
    end
end
